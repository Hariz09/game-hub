  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 to-orange-100 rounded-xl shadow-lg border border-amber-200 overflow-hidden flex flex-col h-full">
      ...
      <div className="p-4 flex-1 flex flex-col min-h-0">
        <div className="grid gap-3 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-amber-300 scrollbar-track-amber-100">
          {Object.entries(EQUIPMENT).map(([key, equipment]) => {
            ...
            return (
              <div
                key={key}
                className={`
                  group bg-white rounded-lg border transition-all duration-200 hover:shadow-md
                  ${canAfford 
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      `}>
                        <Icon 
                          icon={equipment.icon} 
                          className={`text-base ${level > 0 ? 'text-white' : 'text-gray-500'}`} 
                        />
                      </div>
